...
const whereAmI = function () {
    getPosition()
        .then(pos => {
            ...
            return fetch(`https://geocode.xyz/${lat},${lng}?geoit=json&auth=218055250996670323972x107472`);
        })
        .then(res => {
...
const whereAmI = async function () {
    try {
        ...
        // Reverse geocoding
        const resGeo = await fetch(`https://geocode.xyz/${lat},${lng}?geoit=json&auth=218055250996670323972x107472`);
...
Promise.race([
    ...
    .then(res => console.log(res[0], 'Promise.race'))
    .catch(err => console.error(err, 'Promise.race'));
...
]).then(res => console.log(res, 'Promise.allSettled'));
...
Promise.all([
    ...
    .catch(err => console.error(err, 'Promise.all'));
...
Promise.any([
    ...
    .then(res => console.log(res, 'Promise.any'))
    .catch(err => console.error(err, 'Promise.any'));
