...
const account1 = {
    ...
    movementsDates: [
        ...
        '2023-10-12T10:49:59.371Z',
        '2023-10-13T12:01:20.894Z',
    ],
    currency: 'EUR',
    locale: 'pt-PT', // de-DE
};
...
console.log(Math.max(5, 18, '23px', 11, 2)); // don`t work (returns NaN)
